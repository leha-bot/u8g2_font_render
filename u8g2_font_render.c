...
uint16_t font_get_start_symbol_search_postition(const U8G2FontRender_t *font, char chr);
int8_t font_get_glyph(const U8G2FontRender_t *font, U8G2FontGlyph_t *glyph, uint16_t search_position, char chr);
void font_parse_glyph_header(const U8G2FontRender_t *font, U8G2FontGlyph_t *glyph);
uint8_t font_draw_start_x_position(const U8G2FontRender_t *font, const U8G2FontGlyph_t *glyph);
uint8_t font_draw_start_y_position(const U8G2FontRender_t *font, const U8G2FontGlyph_t *glyph);
void font_render_glyph(const U8G2FontRender_t *font, U8G2FontGlyph_t *glyph, uint8_t x, uint8_t y);
